...
今回の回路図は[前回](/posts/2016/0712-get_temperature_and_humidity_withRPi3)と同じです  
![circuit](/images/temp_humi_press.png)  
今回は右側のブロックを使用します。

I2Cデバイスの設定方法は[前回](/posts/2016/0712-get_temperature_and_humidity_withRPi3)を参照してください。  
